...
def json_to_md(filename, md_filename, to_web=False, use_title=True):
    ...
    with codecs.open(md_filename, "w+", 'utf-8') as f:
        pass

    # write data into README.md
    with codecs.open(md_filename, "a+", 'utf-8') as f:
...
if __name__ == "__main__":
    ...
    keywords[
        "Visual Localization"] = "\"Camera Localization\"OR\"Visual Localization\"OR\"Camera Re-localisation\"OR\"Loop Closure Detection\"OR\"visual place recognition\"OR\"image retrieval\""
